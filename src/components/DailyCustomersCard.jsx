...
const mobileData = [
  { month: "january", mobile: 80, fill: "#9EC600" },
  { month: "february", mobile: 200, fill: "#9EC600" },
  { month: "march", mobile: 120, fill: "#9EC600" },
  { month: "april", mobile: 190, fill: "#9EC600" },
  { month: "may", mobile: 130, fill: "#9EC600" },
]

const percentageData = [
  { name: "active", value: 200, fill: "#9EC600" },
...
export function DailyCustomersCard() {
  return (
    <div className="relative h-16 w-16 rounded-full bg-white shadow-lg">
      <ChartContainer
        config={chartConfig}
